...
public class New2Directory extends DirectoryFile //Implemented from classwork
{
    ...
    public void New2Directory(String dataName, String data){
        ...
        if ( ! dataFile.exists() ) {
            System.out.println("No personalized directory 2 file found.");
            System.out.println("A new one will be created.");
            System.out.println("File name:  " + dataFile.getAbsolutePath());
            // If no file found, creates a new file.
        }
        else { // The following avoids error in program
            System.out.println("Reading personalized directory 2 data...");
            try {
                ...
                System.out.println("Error in new data directory file.");
                System.out.println("File name:  " + dataFile.getAbsolutePath());
        ...
        mainLoop: while (true) { // Command options given to user.
            ...
            System.out.println("   5.  Exit from the personalized directory 2.");
            ...
            switch(command) { // Depending on seleced option, actions are carried out.
                case 1:
                System.out.print("\nEnter the data name associated with ");
                System.out.print("the data you want to look up: ");
                ...
                break;
                case 2:
                System.out.print("\nEnter the data name associated with the data entry: ");
                dataName = in.nextLine().trim().toLowerCase();
                ...
                break;
                case 3:
                System.out.print("\nEnter the data name associated with the data entry you want to remove: ");
                dataName = in.nextLine().trim().toLowerCase();
                data = newDirectory.get(dataName);
                if (data == null)
                ...
                break;
                case 5:
                System.out.println("\nExiting personalized directory 2.");
                break mainLoop;
                default:
